<script lang="ts">
	...
	import { arabesco_tiny_webp, game_company_tiny_webp, legend_of_heroes_tiny_webp } from '$lib';
</script>
	...
	<div class="max-w-screen-xl mx-auto font-normal">
		...
		>
			...
			<div class="lg:w-[70%]">
				...
				<p class="max-sm:text-xl max-md:text-1xl text-2xl text-gray-200">
					...
					totalmente responsivo em todos os dispositivos e prioriza o carregamento rápido,
					assegurando uma experiência suave e envolvente para os visitantes.
				</p>
				<a
		...
		>
			...
			<div class="lg:w-[70%]">
				...
				<p class="max-sm:text-xl max-md:text-1xl text-2xl text-gray-200">
					Adoro videogames e decidi criar um site bem sobre o tema. Este projeto envolveu a criação
					de um site de um jogo fictício com imagens geradas por IA para fins ilustrativos. O site é
					totalmente responsivo em todos os dispositivos e otimizado meticulosamente para
					carregamento rápido.
				</p>
				<a
					class="projects__link bg-white rounded hover:border-blue-600 hover:border-4 absolute -bottom-5 -right-5 m-3 font-bold"
