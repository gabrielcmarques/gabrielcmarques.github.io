...
<div class="flex flex-col items-center justify-center mt-[18vh] max-sm:mt-[5vh]">
	<div>
	...
	<div class="mt-2">
		...
		<div class="max-w-screen-lg">
			...
			<a
				...
				target="_blank"
			>
				<p class="text-2xl hover:variant-form-material max-sm:text-lg">
					gabrielchristomarques@gmail.com
				</p>
			</a>
